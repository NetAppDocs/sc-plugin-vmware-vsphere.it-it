...
Seguire le istruzioni riportate in link:scpivs44_download_the_ova_open_virtual_appliance.html["Scarica Open Virtual Appliance (OVA)"^] Per scaricare i file OVA.
