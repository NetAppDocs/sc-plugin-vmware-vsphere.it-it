...
* È possibile associare l'utente a ruoli predefiniti nelle autorizzazioni globali.
...
+
Come minimo, tutti gli utenti devono essere in grado di visualizzare gli oggetti vCenter.  Senza questo privilegio, gli utenti non possono accedere all'interfaccia utente del client VMware vSphere.
