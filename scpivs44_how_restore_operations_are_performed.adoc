...
Vedere https://kb.netapp.com/mgmt/SnapCenter/SCV_clone_or_restores_fail_with_error_'Host_Unresolved_volumes_is_null'#["Articolo della Knowledge base: Il clone o il ripristino dei distributori idraulici non riesce e viene visualizzato l'errore "host Unresolved Volumes is Null"^] per ulteriori informazioni sull'errore.
