...
NOTE: L'aggiornamento a SCV 6.2 è supportato solo su VMware vCenter Server 7 Update 1 e versioni successive; per VMware vCenter Server precedenti alla versione 7 Update 1, è necessario continuare a utilizzare SCV 4.7.  L'aggiornamento è dirompente sulle versioni non supportate del server VMware vCenter.
