...
---
= Collega i VMDK a una VM utilizzando il SnapCenter Plug-in per VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Fasi
. Nell'interfaccia utente del client VMware vSphere, selezionare *Menu* nella barra degli strumenti, quindi selezionare *Host e cluster* dall'elenco a discesa.
