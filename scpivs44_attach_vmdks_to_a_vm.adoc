...
+
È possibile filtrare l'elenco di backup selezionando l'icona del filtro e scegliendo un intervallo di data e ora, selezionando se si desidera eseguire i backup che contengono snapshot VMware, se si desidera eseguire i backup montati e la posizione. Fare clic su *OK*.
