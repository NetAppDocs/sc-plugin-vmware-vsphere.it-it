...
| SPOSTA IL MOUSE SU ELIMINA | * Il file di registro di controllo viene cancellato in base alla conservazione * per impostazione predefinita, vengono conservati solo 10 file 
