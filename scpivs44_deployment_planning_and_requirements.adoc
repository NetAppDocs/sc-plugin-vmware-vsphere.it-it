...
---
= Pianificazione della distribuzione e requisiti per SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
| Strumenti ONTAP per VMware | Il SnapCenter Plug-in for VMware vSphere lo utilizza per gestire i datastore vVol (volumi virtuali VMware). Per le versioni supportate, fare riferimento a https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"^] . 


| Amazon FSxN per l'archiviazione NetApp ONTAP | 9.10 e oltre 
|===
Per le informazioni più recenti sulle versioni supportate, fare riferimento a https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["Tool di matrice di interoperabilità NetApp"^] .
