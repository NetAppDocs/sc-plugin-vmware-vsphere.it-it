...
---
= Accedi alle API REST utilizzando la pagina web dell'API Swagger per l'SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Prima di iniziare
Per accedere alle API REST SnapCenter Plug-in for VMware vSphere , assicurati di disporre dell'indirizzo IP o del nome host del SnapCenter Plug-in for VMware vSphere.
