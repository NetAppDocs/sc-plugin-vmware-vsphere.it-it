...
---
= Rimuovere il SnapCenter Plug-in per VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Fasi
. Accedi all'interfaccia utente di gestione SnapCenter Plug-in for VMware vSphere utilizzando il formato `\https://<OVA-IP-address>:8080` .
+
