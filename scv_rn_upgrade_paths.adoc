...
---
= Percorsi di aggiornamento per il SnapCenter Plug-in per VMware vSphere
:allow-uri-read: 
...
[NOTE]
====
L'aggiornamento al SnapCenter Plug-in per VMware vSphere (SCV) 4.8 e versioni successive è supportato solo su VMware vCenter Server 7 update 1 e versioni successive. Per VMware vCenter Server precedenti alla versione 7 update 1, è necessario continuare a utilizzare SCV 4.7.
