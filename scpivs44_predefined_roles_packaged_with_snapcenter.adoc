...
---
= Ruoli predefiniti inclusi nel pacchetto SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
È possibile visualizzare i ruoli predefiniti nell'interfaccia utente di vCenter selezionando *Menu > Amministrazione > Ruoli* come mostrato nella tabella seguente.
