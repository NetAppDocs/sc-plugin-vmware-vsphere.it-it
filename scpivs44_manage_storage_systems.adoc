...
---
= Gestisci i sistemi di archiviazione nel SnapCenter Plug-in per VMware vSphere
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
IMPORTANT: Se hai aggiunto VM di archiviazione per operazioni di protezione dei dati basate su applicazioni tramite l'interfaccia utente SnapCenter , devi utilizzare la stessa interfaccia utente per modificare tali VM di archiviazione.
...
NOTE: Se hai aggiunto VM di archiviazione per operazioni di protezione dei dati basate su applicazioni tramite l'interfaccia utente SnapCenter , devi utilizzare la stessa interfaccia utente per modificare tali VM di archiviazione.
