...
---
= Controllo degli accessi basato sui ruoli per il SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Il SnapCenter Plug-in for VMware vSphere viene fornito con ruoli vCenter predefiniti.  È necessario utilizzare l'interfaccia utente di vCenter per aggiungere questi ruoli agli utenti di vCenter Active Directory per eseguire operazioni SnapCenter .
