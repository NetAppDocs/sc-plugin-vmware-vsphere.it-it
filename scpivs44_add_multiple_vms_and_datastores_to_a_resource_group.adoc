...
.Fasi
. Nel riquadro di sinistra del Navigator del plug-in SCV, fare clic su *Resource Groups* (gruppi di risorse), quindi selezionare un gruppo di risorse e fare clic su image:scpivs44_image39.png["Errore: Immagine grafica mancante"] *Edit Resource Group* (Modifica gruppo di risorse) per avviare la procedura guidata.
