...
---
= Flusso di lavoro REST API per ripristinare le VM utilizzando l'SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Per ripristinare i backup delle VM con il SnapCenter Plug-in for VMware vSphere , seguire la sequenza richiesta di chiamate alle API REST come descritto di seguito.
