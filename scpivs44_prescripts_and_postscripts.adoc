...
---
= Prescritti e postscript per la SCV
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Un percorso di script PERL potrebbe essere `/support/support/script.pl`
...
Per verificare che i valori dello script siano compilati, controllare quanto segue:
